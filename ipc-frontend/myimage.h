/**
 * @file myimage.h Declaration of the MyImage class.
 */
...
public:
    ...
    /**
     * @brief getPixelRow This function gets a row of pixels from the image.
    ...
    /**
     * @brief setPixelRow This function sets a row of pixels in the image.
